...
buffer = [# header
          ...
          0x34; 0x00; 0x00; 0x00;  # offset to weapon 1 at 0x0078
          0x1c; 0x00; 0x00; 0x00;  # offset to weapon 2 at 0x0064
          ...
          # weapon table (Axe) @ 0x0064
          0xf4; 0xff; 0xff; 0xff;  # 32-bit offset to vtable location (-12) @ 0x0070
          0x00; 0x00;  # padding?
          0x05; 0x00;  # damage
          0x18; 0x00; 0x00; 0x00;  # 32-bit offset to name location ("Axe") @ 0x0084

          # weapon vtable (Axe *and* Sword) @ 0x0070
          0x08; 0x00;  # 16-bit vtable length
          0x0c; 0x00;  # 16-bit table length
          0x08; 0x00;  # field id 0: 0x08 (name)
          0x06; 0x00;  # field id 1: 0x06 (damage)

          # weapon table (Sword) @ 0x0078
          0x08; 0x00; 0x00; 0x00;  # 32-bit offset to vtable location (8) @ 0x0070
          0x00; 0x00;  # padding?
          0x03; 0x00;  # damage
          0x0c; 0x00; 0x00; 0x00;  # 32-bit offset to name location ("Sword") @ 0x008c0
